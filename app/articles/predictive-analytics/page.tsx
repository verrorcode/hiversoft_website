...
export const metadata: Metadata = {
  title: 'AI Predictive Analytics & Decision Making | Hiversoft',
  description: 'Learn how AI-powered predictive analytics can transform your business decision-making process. Discover insights from data analysis.',
  openGraph: {
    title: 'AI Predictive Analytics & Decision Making',
...
export default function PredictiveAnalytics() {
  return (
    <article className="bg-white pb-32 mt-20">
